 ...
 */
@Getter
@Service(provides = IServerEnvironment.class, priority = 10)
public class ServerEnvironment implements IServerEnvironment {
     ...
     */
    public ServerEnvironment(Alley plugin) {
        this.plugin = plugin;
