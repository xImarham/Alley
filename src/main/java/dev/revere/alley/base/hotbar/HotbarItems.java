...
public enum HotbarItems {
    ...
    LAYOUT_EDITOR("&6Layout Editor &7(Right Click)", Material.BOOK, 0, 2, "kiteditor", EnumHotbarType.LOBBY),
    ...
    KIT_EDITOR_PARTY("&6Layout Editor &7(Right Click)", Material.BOOK, 0, 1, "kiteditor", EnumHotbarType.PARTY),
    ...
    LAYOUT_EDITOR_2("&6Layout Editor &7(Right Click)", Material.BOOK, 0, 0, "kiteditor", EnumHotbarType.QUEUE),
