 ...
 * @date 2/07/2025
 */
public interface IBaseRaidingService extends IService {
    /**
     ...
     */
    void setRaidingKitMapping(Kit parentKit, EnumBaseRaiderRole role, Kit roleKit);
     ...
     */
    void removeRaidingKitMapping(Kit parentKit, EnumBaseRaiderRole role);
     ...
     */
    Kit getRaidingKitByRole(Kit parentKit, EnumBaseRaiderRole role);
