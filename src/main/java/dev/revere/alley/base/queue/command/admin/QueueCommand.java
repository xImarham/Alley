package dev.revere.alley.base.queue.command.admin;

import dev.revere.alley.api.command.BaseCommand;
import dev.revere.alley.api.command.CommandArgs;
import dev.revere.alley.api.command.annotation.CommandData;
import dev.revere.alley.base.queue.command.admin.impl.QueueForceCommand;
import dev.revere.alley.base.queue.command.admin.impl.QueueReloadCommand;
