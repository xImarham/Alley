...
import dev.revere.alley.profile.command.player.ChallengesCommand;
import dev.revere.alley.profile.command.player.ChatCommand;
import dev.revere.alley.profile.command.player.MatchHistoryCommand;
...
import dev.revere.alley.profile.command.player.ShopCommand;
import dev.revere.alley.profile.command.admin.statistic.SetCoinsCommand;
import dev.revere.alley.profile.command.player.StatsCommand;
