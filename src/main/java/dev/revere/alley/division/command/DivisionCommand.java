...
import dev.revere.alley.division.command.impl.data.DivisionSetDescriptionCommand;
import dev.revere.alley.division.command.impl.data.DivisionSetDisplayNameCommand;
import dev.revere.alley.division.command.impl.data.DivisionSetIconCommand;
import dev.revere.alley.division.command.impl.data.DivisionSetWinsCommand;
import dev.revere.alley.division.command.impl.manage.DivisionCreateCommand;
import dev.revere.alley.division.command.impl.manage.DivisionDeleteCommand;
import dev.revere.alley.division.command.impl.manage.DivisionListCommand;
import dev.revere.alley.division.command.impl.manage.DivisionViewCommand;
import dev.revere.alley.division.command.impl.player.DivisionsCommand;
