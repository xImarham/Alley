 ...
 * @date 2/07/2025
 */
public interface IDuelRequestService extends IService {
    /**
     ...
     */
    void createAndSendRequest(Player sender, Player initialTarget, Kit kit, @Nullable AbstractArena arena);
