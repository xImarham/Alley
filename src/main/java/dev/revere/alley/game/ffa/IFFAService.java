...
public interface IFFAService extends IService {
     ...
     */
    void createFFAMatch(AbstractArena arena, Kit kit, int maxPlayers);
     ...
     */
    Optional<AbstractFFAMatch> getMatchByPlayer(Player player);
     ...
     */
    AbstractFFAMatch getFFAMatch(String kitName);
     ...
     */
    AbstractFFAMatch getFFAMatch(Player player);
