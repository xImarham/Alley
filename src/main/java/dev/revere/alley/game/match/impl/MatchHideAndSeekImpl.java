 ...
 */
@Getter
public class MatchHideAndSeekImpl extends MatchRegularImpl {
    ...
    private final IArenaService arenaService = plugin.getService(IArenaService.class);
    private final AbstractArena intermissionArena = arenaService.getArenaByName("IntermissionArena");
     ...
     */
    public MatchHideAndSeekImpl(Queue queue, Kit kit, AbstractArena arena, boolean ranked, GameParticipant<MatchGamePlayerImpl> participantA, GameParticipant<MatchGamePlayerImpl> participantB) {
