...
public class FFARepository {
    ...
    public void loadFFAMatches() {
        FileConfiguration config = Alley.getInstance().getConfigHandler().getConfigByName("storage/ffa.yml");
    ...
    public void saveFFAMatch(AbstractFFAMatch match) {
        ...
        Alley.getInstance().getConfigHandler().saveConfig(Alley.getInstance().getConfigHandler().getConfigFileByName("storage/ffa.yml"), config);
    }
