package me.emmy.alley.visual.tablist;
...
public class TablistVisualizer implements ITablist {
    ...
    public void update(Player player) {
        if (Alley.getInstance().getProfileRepository().getProfile(player.getUniqueId()).getProfileData().getProfileSettingData().isTablistEnabled()) {
