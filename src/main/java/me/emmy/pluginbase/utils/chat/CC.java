package me.emmy.pluginbase.utils.chat;
...
public class CC {
    ...
    public static void on(long timeTaken) {
        ...
        Bukkit.getConsoleSender().sendMessage(CC.translate(" &f| Plugin: &b" + PluginBase.getInstance().getDescription().getName()));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" &f| Authors: &b" + PluginBase.getInstance().getDescription().getAuthors().toString().replace("[", "").replace("]", "")));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" "));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" &f| Version: &b" + PluginBase.getInstance().getDescription().getVersion()));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" &f| Link: &b" + PluginBase.getInstance().getDescription().getWebsite()));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" "));
